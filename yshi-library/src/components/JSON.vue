...
<template>
  <div class="json-lab">
    ...
    <section class="lab-section">
      ...
      <!-- Activity 6: Render a list containing author names and their birth years. Hint: Make use of the nodev-for directive to iterate through the array of authors. -->
      ...
      <ul>
        <li
          ...
          :style="isGeorgeOrwell(author) ? 'background-color: yellow; color: black;' : ''"
        >
...
const bookStoreName = bookstores.name;
